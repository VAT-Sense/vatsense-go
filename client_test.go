...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.Rates.List(context.Background(), vatsense.RateListParams{})
	if userAgent != fmt.Sprintf("VatSense/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Rates.List(context.Background(), vatsense.RateListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Rates.List(cancelCtx, vatsense.RateListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Rates.List(deadlineCtx, vatsense.RateListParams{})
		if err == nil {

...
<a href="https://pkg.go.dev/github.com/stainless-sdks/vat-sense-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/vat-sense-go.svg" alt="Go Reference"></a>

<!-- x-release-please-end -->

The Vat Sense Go library provides convenient access to the [Vat Sense REST API](https://vatsense.com)
...
```go
import (
	"github.com/stainless-sdks/vat-sense-go" // imported as vatsense
)
```
...
```sh
go get -u 'github.com/stainless-sdks/vat-sense-go@v0.0.1'
```
...
The vatsense library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/vat-sense-go/option).
...
`*vatsense.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `vatsense.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/vat-sense-go/issues) with questions, bugs, or suggestions.

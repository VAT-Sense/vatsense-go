...
// interacting with the vat-sense API. You should not instantiate this client
...
// DefaultClientOptions read from the environment (VAT_SENSE_USERNAME,
...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("VAT_SENSE_USERNAME"); ok {
...
// environment (VAT_SENSE_USERNAME, VAT_SENSE_PASSWORD, VAT_SENSE_BASE_URL). The
